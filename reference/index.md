...
- [`get_ff3_factors()`](https://mjfrigaard.github.io/stocktipr/reference/get_ff3_factors.md)
  : Retrieve Fama-French three-factor data via tidyfinance
- [`compute_rolling_vol()`](https://mjfrigaard.github.io/stocktipr/reference/compute_rolling_vol.md)
  : Compute rolling annualised volatility
- [`summarise_performance()`](https://mjfrigaard.github.io/stocktipr/reference/summarise_performance.md)
  : Summarise performance metrics by ticker
- [`default_tickers`](https://mjfrigaard.github.io/stocktipr/reference/default_tickers.md)
...
- [`` `%||%` ``](https://mjfrigaard.github.io/stocktipr/reference/grapes-or-or-grapes.md)
